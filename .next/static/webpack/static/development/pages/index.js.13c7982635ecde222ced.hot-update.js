...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function getNext(activities) {
      var next = [];
      var date = new Date();
      var active = activities.map(function (activity, index) {});
    ...
    value: function setActive() {
      ...
      this.active = activities.filter(function (activity) {
...
//# sourceMappingURL=index.js.13c7982635ecde222ced.hot-update.js.map