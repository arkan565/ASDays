...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function setTimeout() {
      ...
      var minTime = -1;
      var date = new Date();
      this.active.map(function (activity) {
        var splitFinishDate = activity.finishTime.split(':');
        var finishHour = parseInt(splitFinishDate[0], 10);
      ...
      this.next.map(function (activity) {
        var splitStartDate = activity.startTime.split(':');
        var startHour = parseInt(splitStartDate[0], 10);
        ...
        _this2.timeout = _this2.setTimeout(function () {
...
//# sourceMappingURL=index.js.0a97ed7ccacab1f948e9.hot-update.js.map