...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function setTimeout() {
      ...
      for (var i = 0; i < this.nextActivities.length; i++) {
        var activity = this.nextActivities[i];
        var splitStartDate = activity.startTime.split(':');
        var startHour = parseInt(splitStartDate[0], 10);
        var startMinute = parseInt(splitStartDate[1], 10);
        var secondsLeft = 60 - date.getSeconds() + 1;
        var minutes = startMinute != 0 ? startMinute - date.getMinutes() - 1 : 60 - date.getMinutes() - 1;
        var hours = startHour != 0 ? startHour - date.getHours() - 1 : 24 - date.getHours() - 1;
      ...
      if (minTime != -1) {
        this.timeout = this.setTimeout(function () {}, minTime);
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.1ebf2a2199a27021c00e.hot-update.js.map