...
function (_React$Component) {
  ...
  function ActivitiesGrid(props) {
    ...
    console.log(_this.props.activities);
    return _this;
  }
  ...
  _createClass(ActivitiesGrid, [{
    ...
    value: function renderActivities() {
      try {
        return this.props.activities.forEach(function (activity) {
          var splitStartDate = activity.startDate.split(':');
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: this.activitiesGridStyle
...
//# sourceMappingURL=index.js.03cfda7ce0ca0d4c6a55.hot-update.js.map