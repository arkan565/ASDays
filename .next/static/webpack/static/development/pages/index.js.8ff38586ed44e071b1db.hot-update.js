  ...
  _createClass(ActiveActivitiesCard, [{
    ...
    value: function renderChart() {
      if (this.props.activity.active) {
        ...
        var data = [{
          name: 'Passed time',
          data: (date.getHours() - startHour) * 3600 + date.getMinutes() * 60 + date.getSeconds(),
          fill: 'rgb(255, 221, 87)'
        }, {
          name: 'Remaining time',
          data: duration - ((date.getHours() - startHour) * 3600 + date.getMinutes() * 60 + date.getSeconds()),
          fill: 'grey'
        }];
...
//# sourceMappingURL=index.js.8ff38586ed44e071b1db.hot-update.js.map